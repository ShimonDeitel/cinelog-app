    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Cinelog - Movie Diary Pro") {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/cinelog-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/cinelog-app/terms.html")!)
                }
            }
